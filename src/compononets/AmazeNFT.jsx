        ...
        <div>
              <div>
                <p className="background"><svg width="1440" height="326" viewBox="0 0 1440 326" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <filter id="filter0_b_0_185" x="-50" y="-50" width="1540" height="426" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                            <feGaussianBlur in="BackgroundImageFix" stdDeviation="25" />
                            <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_0_185" />
                            <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_0_185" result="shape" />
                        </filter>
                    </defs>
                </svg>
                </p>
            ...
            <div>
                <h1 class="amaze1"> The amazing NFT art of the world here </h1>
            ...
            <div>
                <h1 class="icon1" >
                    ...
                    <h1 className="amaze2">Fast Transaction</h1>

                </h1>
                <h1 class="amaze3"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam etiam viverra tellus imperdiet.</h1>
            </div>
            <div>
                <h1 className="icon2">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
